export const webProjects = [
    ...
    },
    {
        ...
        description:
            "This was rewritten in April 2022. I migrated to Next.js and incorporated authentication using google, github and email. In the previous version, the authentication was written by myself but this next-auth is better in terms of security and people don't like to create new accounts. It is deployed to Vercel no cold starts from Heroku.",
        technologiesUsed:
            "Nextjs, Postgres, Prisma, Vercel, Next-Auth, SCSS, Git",
